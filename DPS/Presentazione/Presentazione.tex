...
%------------------------------------------------
\subsection{Client Leave}

\begin{frame}
	\frametitle{Client Leave}
	
%	\includemovie[poster,autoplay,externalviewer, text={\small(/Users/home/omnetpp-5.0/samples/DistPubSub/DPS/Video/client_leave_join.mp4)}]{6cm}{6cm}{bloch.mp4}
