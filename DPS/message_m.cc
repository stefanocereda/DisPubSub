...
Message_msg& Message_msg::operator=(const Message_msg& other)
{
...
void Message_msg::setTopic(int topic)
{
    this->topic = topic;
}
...
class Message_msgDescriptor : public omnetpp::cClassDescriptor
{
  ...
  public:
    Message_msgDescriptor();
    virtual ~Message_msgDescriptor();
...
Register_ClassDescriptor(Message_msgDescriptor);

Message_msgDescriptor::Message_msgDescriptor() : omnetpp::cClassDescriptor("Message_msg", "omnetpp::cMessage")
{
    propertynames = nullptr;
}

Message_msgDescriptor::~Message_msgDescriptor()
{
    delete[] propertynames;
}

bool Message_msgDescriptor::doesSupport(omnetpp::cObject *obj) const
{
    return dynamic_cast<Message_msg *>(obj)!=nullptr;
}

const char **Message_msgDescriptor::getPropertyNames() const
{
    if (!propertynames) {
...
const char *Message_msgDescriptor::getProperty(const char *propertyname) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
...
const char *Message_msgDescriptor::getFieldTypeString(int field) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
const char *Message_msgDescriptor::getFieldProperty(int field, const char *propertyname) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
int Message_msgDescriptor::getFieldArraySize(void *object, int field) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
std::string Message_msgDescriptor::getFieldValueAsString(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
bool Message_msgDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
const char *Message_msgDescriptor::getFieldStructName(int field) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
void *Message_msgDescriptor::getFieldStructValuePointer(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
